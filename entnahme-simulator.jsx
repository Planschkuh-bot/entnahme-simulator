...
export default function EntnahmeSimulator() {
  ...
  const [staticRate, setStaticRate] = useState(8);
  ...
  const [blockLen, setBlockLen] = useState(5);
      ...
      <div style={{ maxWidth: 1220, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: 10, marginBottom: 16, flexWrap: 'wrap', alignItems: 'center' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'flex-start' }}>
            ...
            {mode === 'bootstrap' && (
              <Slider label="Blocklänge" value={blockLen} min={1} max={30} step={1}
                onChange={setBlockLen} format={(v) => v + ' Jahre'}
                hint="Zusammenhängende Blöcke beim Ziehen"
                tip="Länge der zusammenhängenden Jahresblöcke. Kleinere Blöcke = mehr Unabhängigkeit zwischen den Zufallsjahren." />
            )}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
          ...
          <div>
            ...
            {entnahmeStrategie === 'dynamisch' && (
              <Slider label="Statische Referenzrate" value={staticRate} min={0} max={20} step={0.1}
          ...
          <div style={{ background: '#EEF1EF', borderRadius: 16, padding: 24, width: '90vw', maxWidth: 1200, height: '85vh', display: 'flex', flexDirection: 'column', position: 'relative' }} onClick={(e) => e.stopPropagation()}>
            ...
            {expandedChart === 'vermoegen' && (
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                ...
                <div style={{ fontSize: 13, color: '#5B6B65', marginBottom: 12 }}>10./50./90. Perzentil, Gesamtvermögen</div>
            ...
            {expandedChart === 'ausfall' && (
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                ...
                <div style={{ flex: 1, minHeight: 300 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={failureChartData} margin={{ top: 20, right: 30, left: 10, bottom: 30 }}>
                      <CartesianGrid stroke="#E3E8E5" vertical={false} />
                      <XAxis dataKey="age" tick={{ fill: '#5B6B65', fontSize: 13 }} tickLine={false} axisLine={{ stroke: '#D3DAD6' }} />
